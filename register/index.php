...
<body>
	<a id="logo" href="/"><img src="/image/logo.png" /></a>
	<div id="container">
			<?php if($result==null||!isset($_POST['send'])){ ?>
				<h1>注册新的账号</h1>
			<?php }else{ ?>
				<h1 class='error'>注册失败! 请重新注册</h1>
			...
			<form method="post" id="customForm" action="#">
				...
				<div>
					...
					<input id="gender0" name="gender" type="radio" value='0'><span>保密</span></input>
					<input id="gender1" name="gender" type="radio" value='1'><span>男</span></input>
					<input id="gender2" name="gender" type="radio" value='2'><span>女</span></input>
				</div>
				<div>
